...
const Messenger = () => {
   ...
   const [typingMessage,setTypingMessage] = useState('');
    ...
    useEffect(()=>{
        if(socketMessage && currentFriend){
            if(socketMessage.senderId===currentFriend._id && socketMessage.
    ...
    useEffect(()=>{
       if(socketMessage && socketMessage.senderId!==currentFriend._id && socketMessage.
        receiverId===myInfo.id){
            notificationSPlay();
  ...
  return (
                ...
                <div className="left-side">
                    <div className="top">
                        <div className="image-name">
                            ...
                            <div className="name">
                                <h2 className={themeMood==='dark'?"dark_name":"light_name"}>{myInfo.userName}</h2>
                            </div>
                        </div>
                    ...
                    {/* <div className="active-friends">
    {
        ...
        <ActiveFriends setCurrentFriend={setCurrentFriend} user={u} />) : '' 
    }
                    ...
                    <div className="friends">
       {
          friends && friends.length>0 ? friends.map((fd)=> <div onClick={()=>setCurrentFriend(fd.fndInfo)}
           className={currentFriend._id===fd.fndInfo._id ? "hover-friend active":"hover-friend"}>
            <Friend activeUser={activeUser} myId={myInfo.id} friend={fd}/>
           </div>) : 'No Friend'
       }
        ...
        {
            currentFriend ? <RightSide currentFriend={currentFriend} 
            inputHendle={inputHendle} newMessage={newMessage}
            sendMessage={sendMessage} message={message}
            scrollRef={scrollRef} emojiSend={emojiSend}
            ImageSend={ImageSend} activeUser={activeUser}
